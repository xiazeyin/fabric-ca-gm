...
import (
	...
	cfcsr "github.com/xiazeyin/cfssl-gm/csr"
	"github.com/xiazeyin/cfssl-gm/initca"
	"github.com/xiazeyin/cfssl-gm/signer"
	cflocalsigner "github.com/xiazeyin/cfssl-gm/signer/local"
	...
	cadbfactory "github.com/xiazeyin/fabric-ca-gm/lib/server/db/factory"
...
func validateKeyType(cert *x509.Certificate) error {
	...
	case *sm2.PublicKey:
		return nil
	default:
		return errors.New("Unsupported key type: not sm2")
	}
}
